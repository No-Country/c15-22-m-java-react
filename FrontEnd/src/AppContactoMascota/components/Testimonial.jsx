		...
		<section className="p-6">
			<div className="container max-w-xl mx-auto">
				<div className="flex flex-col items-center w-full p-6 space-y-8 rounded-md lg:h-full lg:p-8 dark:bg-gray-900 dark:text-gray-100">
					...
					<blockquote className="max-w-lg text-lg italic font-medium text-center">"Feliz de tener esta web que unifica las busquedas de las mascotas y gracias a eso me pude reencontrar con mi perrito. Gracias!"</blockquote>
