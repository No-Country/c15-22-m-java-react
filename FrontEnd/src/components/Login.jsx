    ...
    return (
      <section className="h-full bg-neutral-200 dark:bg-neutral-700  ">
          <div className='text-xl  absolute top-[150px] right-[70px] hover:bg-red-500'>
              <img className="w-6 " src="/images/close.png" alt="" /></div>
              <span className="i-tdesign-close-circle"></span>
        <div className="container h-full p-10 ">
          ...
          <div className=" g-6 flex h-full border-beige-secondary shadow-ml flex-wrap items-center justify-center text-neutral-800 dark:text-neutral-200">
            <div className="w-full">
                  ...
                  <div className="px-4 md:px-0 lg:w-6/12  mt-5">
                    <div className="md:mx-6 md:p-12">
                      ...
                      <div className="text-center">
                        ...
                        Estamos <span className="text-red-primary">felices</span> de volverte a ver
                        </h4>
                      </div>
              ...
              <button className="flex flex-wrap justify-center w-full border border-gray-300 hover:border-gray-500 px-2 py-1.5 rounded-md">
                <img className="w-5 mr-2" src="/images/facebook.png"/>
                Iniciar sesión con  Facebook
              </button>
  
                  </div>
              <p className="mx-auto flex my-4 justify-center">o iniciar sesión con credenciales</p>
                  ...
                  >
                      <img className="w-[350px]" src="/images/logoContacto.png" alt="" />
                      ...
                      <img className=" mt-[20px]" src="/images/contactoMascota.png" alt="" />
